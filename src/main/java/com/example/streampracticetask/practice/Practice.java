...
public class Practice {
    ...
    public Practice(CountryService countryService, DepartmentService departmentService, EmployeeService employeeService, JobHistoryService jobHistoryService, JobService jobService, LocationService locationService, RegionService regionService) {
...
//                .findFirst().get().getLocation().getCountry().getRegion();
        // Solution 2
        return departmentService.readAll().stream().filter(department -> department.getDepartmentName().equals("IT")).findFirst().orElseThrow(() -> new Exception("No Department Found")).getLocation().getCountry().getRegion();
    }

    // Display all the departments where the region of department is 'Europe'
    public static List<Department> getAllDepartmentsWhereRegionOfCountryIsEurope() {
        //TODO Implement the method
        return departmentService.readAll().stream().filter(department -> department.getLocation().getCountry().getRegion().getRegionName().equals("Europe")).collect(Collectors.toList());
    }

    // Display if there is any employee with salary less than 1000. If there is none, the method should return true
    public static boolean checkIfThereIsNoSalaryLessThan1000() {
        //TODO Implement the method
        return employeeService.readAll().stream().noneMatch(p -> p.getSalary() < 1000);
    }

    // Check if the salaries of all the employees in IT department are greater than 2000 (departmentName: IT)
    public static boolean checkIfThereIsAnySalaryGreaterThan2000InITDepartment() {
        //TODO Implement the method
        return employeeService.readAll().stream().filter(p -> p.getDepartment().getDepartmentName().equals("IT")).allMatch(p -> p.getSalary() > 2000);
    }

    // Display all the employees whose salary is less than 50
    public static List<Employee> getAllEmployeesWithLessSalaryThan5000() {
        //TODO Implement the method
        return employeeService.readAll().stream().filter(p -> p.getSalary() < 5000).collect(Collectors.toList());
    }

    // Display all the employees whose salary is between 6000 and 7000
    public static List<Employee> getAllEmployeesSalaryBetween() {
        //TODO Implement the method
        return employeeService.readAll().stream().filter(p -> p.getSalary() > 6000 && p.getSalary() < 7000).collect(Collectors.toList());
    }

    // Display the salary of the employee Grant Douglas (lastName: Grant, firstName: Douglas)
    public static Long getGrantDouglasSalary() throws Exception {
        //TODO Implement the method
        return employeeService.readAll().stream().filter(employee -> employee.getFirstName().equals("Douglas")).filter(employee -> employee.getLastName().equals("Grant")).findAny().get().getSalary();
    }
...
//                .orElseThrow(() -> new Exception("Something went wrong!") ).getJob();
    ...
    // Display the sec nd maximum salary an employee gets
...
//                .sorted().distinct().limit(2).collect(Collectors.toList()).get(1);
    ...
    public static Long getTotalDepartmentsNumber() {
        ...
        return departmentService.readAll().stream().map(Department::getDepartmentName).count();
    }
    ...
    public static Employee getEmployeeWhoseFirstNameIsAlyssaAndManagersFirstNameIsEleniAndDepartmentNameIsSales() throws Exception {
        ...
        return employeeService.readAll().stream()
                ...
                .filter(employee -> employee.getLastName().equals("Eleni"))
    ...
    public static List<JobHistory> getAllJobHistoriesStartDateAfterFirstDayOfJanuary2005() {
        //TODO Implement the method
        return jobHistoryService.readAll().stream().filter(jobHistory -> jobHistory.getStartDate().isAfter(LocalDate.of(2005, 1, 1))).collect(Collectors.toList());
    }
    ...
    public static List<String> getAllEmployeesInitials() {
        //TODO Implement the method
        return employeeService.readAll().stream()
                .map(p -> p.getFirstName().substring(0, 1) + p.getLastName().substring(-1)).collect(Collectors.toList());
    }

    // Display the full names of all the employees
    public static List<String> getAllEmployeesFullNames() {
        //TODO Implement the method
        return employeeService.readAll().stream().map(p -> p.getFirstName() + " " + p.getLastName()).collect(Collectors.toList());
    }
    ...
    public static Integer getLongestNameLength() throws Exception {
        ...
        Employee employee = employeeService.readAll().stream()
                .reduce((employee1, employee2) -> employee1.getFirstName().length() + employee1.getLastName().length() > employee2.getFirstName().length() + employee2.getLastName().length() ? employee1 : employee2).orElseThrow(() -> new Exception("Something went wrong"));
